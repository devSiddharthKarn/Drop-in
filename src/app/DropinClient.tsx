...
export default function DropinClient({
  ...
  const [receiveMessage, setReceiveMessage] = useState(initialMessage);
  const [receiving, setReceiving] = useState(false);
  const [receivedFiles, setReceivedFiles] = useState<FileEntry[]>(initialFiles);
  ...
  const handleUpload = async (event: FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      setShareLink(payload.data.link ?? null);
  ...
  const copyLink = async () => {
    ...
    try {
      ...
      setUploadMessage("Copy failed. Share the link manually.");
    }
  };
              ...
              <div className={styles.uploadMain}>
                ...
                >
                  ...
                  <div className={styles.dropHint}>
                    <div className={styles.dropIcon}>v</div>
                ...
                {shareToken ? (
                  <div className={styles.tokenPanel}>
                    <div className={styles.tokenInfo}>
                      ...
                      {shareLink ? <span className={styles.tokenLink}>{shareLink}</span> : null}
                    </div>
                    <div className={styles.tokenActions}>
                      ...
                      {shareLink ? (
                        <button type="button" className={styles.ghostButton} onClick={copyLink}>
                          Copy link
                        </button>
                      ) : null}
                    </div>
